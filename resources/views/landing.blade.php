    ...
    <body class="antialiased">
        <div class="header">
            ...
            <div class="header-seccions">
                <ul>
                    ...
                    <li>Talleres</li>
                    <li>Contacto</li>
                    <li class="boton-login" ><a href="{{ route('login') }}">Login</a><i class="fa-solid fa-right-to-bracket login"></i></a></li>
                </ul>
            </div>
        </div>
        <div class="main">
            <div class="main1">
                ...
                <div class="main1-botones">
                    ...
                    <a href="{{ route('register') }}" class="registrarse">Registrate<i class="fa-solid fa-right-to-bracket login"></i></a>
                </div>
            </div>
            <div class="main2">
                <div class="main3">
        ...
        <div class="contacto">
            <div class="formulario-contenido">
                ...
                <section>
                    <input class="botons boton-registrar type="submit" value="Registrar">
                </section>
            </div>
        </div>
